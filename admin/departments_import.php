    ...
    <div class="main-content">
        ...
        <div class="page-body">
            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-4">
                <div>
                    <h4 class="fw-bold mb-1" style="color: #0b1f3a;">Import Departments from Excel</h4>
            ...
            <?php if ($step === 'upload'): ?>
                <div class="admas-card p-4" style="max-width: 640px;">
                    ...
                    <form method="post" action="<?= htmlspecialchars(BASE_URL) ?>/admin/departments_import.php" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-primary" style="background-color: #0ea5e9; border-color: #0ea5e9;" <?= empty($existingFaculties) ? 'disabled' : '' ?>>
