<?php
/**
 * Profile & Password (System Administrator only) — edit own Full Name/Email,
 * change username, and change password.
 */
    ...
    <div class="main-content">
        ...
        <div class="page-body">
            ...
            <div class="admas-card p-4 mb-3">
                ...
                <form method="post" enctype="multipart/form-data" action="<?= htmlspecialchars(BASE_URL) ?>/admin/profile.php" class="d-flex align-items-center gap-3 mb-4">
                ...
                <form method="post" action="<?= htmlspecialchars(BASE_URL) ?>/admin/profile.php" class="row g-3">
            ...
            <div class="row g-3">
                <div class="col-lg-6">
                    ...
                    <div class="admas-card p-4 h-100">
                        ...
                        <form method="post" action="<?= htmlspecialchars(BASE_URL) ?>/admin/profile.php">
